                ...
                {analysisResult ? (
                   <SlideUp>
                    ...
                    {activeTab === 'resources' ? (
                        ...
                        <>
                        {/* Legal Holistic Narrative - The "Big Picture" Story */}
                        {analysisResult.holistic_narrative && (
                            <SlideUp className="mb-8">
                                <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 rounded-3xl p-8 text-white shadow-2xl border border-white/5 shadow-zinc-200 relative overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-6">
                                            ...
                                            <div className="flex flex-col">
                                                <h3 className="text-xl font-black uppercase tracking-tight leading-none">Legal Holistic Narrative</h3>
                                                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-[0.2em] mt-1">AI-Powered Synthesis</span>
                                            </div>
                                        </div>
                                        <p className="text-lg md:text-xl font-medium leading-relaxed md:max-w-3xl text-zinc-200">
                                            {analysisResult.holistic_narrative}
                                        </p>
                                        <div className="mt-8 flex items-center gap-4 border-t border-white/10 pt-6">
                                            <div className="flex -space-x-2">
                                                <div className="w-8 h-8 rounded-full bg-blue-500 border-2 border-zinc-900 flex items-center justify-center text-[10px] font-black">AI</div>
                                                <div className="w-8 h-8 rounded-full bg-zinc-700 border-2 border-zinc-900 flex items-center justify-center text-[10px] font-black">VG</div>
                                            </div>
                                            <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">
                                                Generated by Vidhi-Brain Engine • Grounded in Indian Law
                                            </p>
                                        </div>
                                    </div>
                                </div>
